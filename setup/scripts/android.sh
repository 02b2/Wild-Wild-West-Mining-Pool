...
echo "So you like the wild side of things, huh?"
echo -n "Hopefully not too wild to rememeber your wallet address lol. Easiest if you copy it beforehand so it's ready or save it to a variable. "
read WALLET_ADDRESS
